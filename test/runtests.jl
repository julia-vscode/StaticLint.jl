...
""") == [1, 1, 1]
    ...
    @testset "on demand resolving of export statements" begin
        ...
        kw_default_fail("f(x::Float64 = 1)")
        kw_default_fail("f(x::Float32 = 3.4")
        kw_default_fail("f(x::Float32 = -23.")
        kw_default_fail("f(x::Int = 0.1)")
        kw_default_fail("f(x::String = 0.1)")
        kw_default_fail("f(x::Symbol = \"a\"")
        kw_default_fail("f(x::Char = \"a\"")
        kw_default_fail("f(x::Bool = 1")
        kw_default_fail("f(x::Bool = 0x01")
        kw_default_fail("f(x::UInt8 = 0b000000000")
        kw_default_fail("f(x::UInt16 = 0b0000_0000_0000_0000_0")
        kw_default_fail("f(x::UInt32 = 0b0")
        kw_default_fail("f(x::UInt64 = 0b0_0")
        kw_default_fail("f(x::UInt128 = 0b0")
        kw_default_fail("f(x::UInt8 = 0o0000")
        kw_default_fail("f(x::UInt16 = 0o0")
        kw_default_fail("f(x::UInt32 = 0o00000000000000")
        kw_default_fail("f(x::UInt64 = 0o0_0")
        kw_default_fail("f(x::UInt128 = 0o00")
        kw_default_fail("f(x::UInt8 = 0x000")
        kw_default_fail("f(x::UInt16 = 0x00000")
        kw_default_fail("f(x::UInt32 = 0x0000_00_000")
        kw_default_fail("f(x::UInt64 = 0x000_0_0")
        kw_default_fail("f(x::UInt128 = 0x000000")
    end
end
